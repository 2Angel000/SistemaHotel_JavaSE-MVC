...
public class Queries {
    ...
    public String InsertHabitacion(String habitacion, String tipoH, int camas, int personas, Double precio, String desc, String estado) {
        String insert = "INSERT INTO habitacion (habitacion, tipo_habitacion, no_camas, no_personas, precio, descripcion, estado) VALUES ('" + habitacion + "', '" + tipoH + "','" + camas + "','" + personas + "'," + precio + ",'" + desc + "','" + estado + "')";
        return insert;
    }
